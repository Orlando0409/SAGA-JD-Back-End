...
export class MaterialService {
    ...
    async createMaterial(dto: CreateMaterialDto, idUsuario: number) {
        ...
        const materialData: any = {
            ...
            Numero_Estanteria: dto.Numero_Estanteria,
        ...
        try {
            await this.auditoriaService.logCreacion(
                ...
                savedMaterial.Id_Material,
                {
                    ...
                    Numero_Estanteria: materialCreado.Numero_Estanteria,
    ...
    async updateMaterial(Id_Material: number, dto: UpdateMaterialDto, usuarioId: number) {
        ...
        const datosAnteriores = {
            ...
            Numero_Estanteria: materialExistente.Numero_Estanteria,
        ...
        try {
            const datosNuevos = {
                ...
                Numero_Estanteria: materialActualizadoCompleto.Numero_Estanteria,

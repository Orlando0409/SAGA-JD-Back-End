export function QuejaMail(data: {
  ...
  <div style="font-family: 'Helvetica', Arial, sans-serif; background-color: #f4f6f8; padding: 40px; text-align: center;">
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 10px; padding: 30px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
      ...
      <h2 style="color: #333333; margin-bottom: 20px;">📢 Confirmación de queja recibida</h2>

      <p style="color: #555555; font-size: 16px; line-height: 1.5; text-align:left;">
        Hola <strong>${fullName || 'Usuario'}</strong>, hemos recibido tu queja. A continuación encontrarás un resumen de tu queja.
      </p>
      ...
      <p style="color: #999999; font-size: 14px; line-height: 1.5; margin-top:18px;">Nos pondremos en contacto contigo a la brevedad posible para dar seguimiento a tu queja.</p>

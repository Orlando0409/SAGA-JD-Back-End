  ...
  <div style="font-family: 'Helvetica', Arial, sans-serif; background-color: #f4f6f8; padding: 40px; text-align: center;">
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; border-radius: 10px; padding: 30px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
      ...
      <p style="color: #555555; font-size: 16px; line-height: 1.5; text-align:left;">
        Hola <strong>${fullName || 'Usuario'}</strong>, tu queja ha sido respondida por alguno de nuestros miembros de la ASADA. Aquí tienes el resumen y la respuesta:
      </p>
      ...
      <div style="text-align:left; background:#f9fbff; padding:12px; border-radius:8px; border:1px solid #eef6ff;">
        ...
        <p style="margin:6px 0"><strong>Tu queja:</strong><br/>${data.descripcion || 'N/A'}</p>
      </div>
      ...
      <div style="background:#fff3cd; padding:12px; border-radius:8px; border:1px solid #ffeaa7; margin-top:18px; text-align:left;">
        <p style="margin:0; color:#856404;">
          <strong>Gracias por tu queja:</strong><br/>
          Valoramos mucho tu comunicación, ya que nos ayuda a identificar áreas de mejora y brindar un mejor servicio.
        </p>
      </div>
